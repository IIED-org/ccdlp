 ...
 *
 */
$drupal_hash_salt = 'jfT4POZmJdvhgciYFQleDpGsSdOkOdlaqEa8l5D70j0';
...
if (file_exists('/var/www/site-php')) {
  require('/var/www/site-php/ccdlp/ccdlp-settings.inc');
}
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_devcloud_ccdlp_dev_default.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_devcloud_ccdlp_dev_default.inc';
}
// </DDSETTINGS>
